...
//                    });
        ...
        case "mouseenter":
            if (gotopreview) {
                console.log(thisuser.attr("select_state"));
            }
...
//                    lineHeight + 10, i * lineHeight + 5, "subject");
                        ...
                        } else if (d3.select("#listtype").node().value === "list") {
                            toFront(d3.select("#detaildiv"), true);
                        } else if (d3.select("#listtype").node().value === "cloud") {
                            toFront(d3.select("#fdgdiv"), true);
                        }
                    });
}
